-- =====================================================
-- AlboCarRide Features - ULTRA SIMPLE (No Complex Policies)
-- =====================================================
...
-- Simple policies - just check user owns the record
...
CREATE POLICY driver_mobile_money_policy ON public.driver_mobile_money
