      ...
      if (userId != null) {
        ...
        if (mounted) {
          setState(() {
            ...
            _recentDestinations = List<Map<String, dynamic>>.from(recentDestinationsResponse);
    ...
    return ListView(
      children: [
        ...
        if (_recentDestinations.isNotEmpty) ...[
          ...
          ..._recentDestinations.map((destination) => _buildRecentDestinationItem(destination)),
        ],
          ...
          return ListTile(
            ...
            onTap: () async {
              ...
              if (result['latitude'] != null && result['longitude'] != null) {
                ...
                final coords = await LocationService.geocodeAddress(description);
